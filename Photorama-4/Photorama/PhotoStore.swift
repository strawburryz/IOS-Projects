...
// On Updating the Data Source in Book
...
class PhotoStore {
    ...
    func fetchAllPhotos(with predicate: NSPredicate? = nil, completion: @escaping (Result<[Photo], Error>) -> Void) {
        let fetchRequest: NSFetchRequest<Photo> = Photo.fetchRequest()
        fetchRequest.predicate = predicate

        if let entity = NSEntityDescription.entity(forEntityName: "Photo", in: persistentContainer.viewContext),
           entity.propertiesByName.keys.contains("dateTaken") {
